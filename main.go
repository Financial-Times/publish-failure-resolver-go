...
func main() {
	...
	app.Action = func() {
		...
		parallelRepublisher := newNotifyingParallelRepublisher(func() sequentialRepublisher { return newNotifyingSequentialRepublisher(republisher, rateLimit) }, *parallelism)
		if err != nil {
